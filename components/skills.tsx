...
import { FaJs, FaReact, FaHtml5, FaCss3, FaBootstrap, FaGitAlt, FaGithub, FaDocker, FaNodeJs } from "react-icons/fa";
import { RiNextjsFill, RiTailwindCssFill } from "react-icons/ri";
import { SiMongodb, SiMysql, SiRedux, SiExpress, SiPostman, SiPrisma, SiGraphql } from "react-icons/si";
...
const skillCategories = [
  ...
  },
  {
    ...
    skills: [
      ...
      { name: "Prisma ORM", icon: <SiPrisma className="text-sky-500" /> },
      { name: "GraphQL", icon: <SiGraphql className="text-pink-500" /> },
      { name: "RESTful APIs", icon: <TbApi className="text-orange-400" /> },
    ],
  },
  {
    title: "Databases",
