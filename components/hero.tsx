...
import { gmailHref } from "@/utils/gmail";
      ...
      <div className="grid md:grid-cols-3 gap-10 items-center max-w-6xl mx-auto">
        ...
        >
          <div className="space-y-2">
            <h1 className="text-3xl sm:text-4xl font-bold tracking-tight">Nitesh Kumar</h1>
          ...
          <div className="flex flex-col sm:flex-row gap-2 sm:gap-4 text-sm text-muted-foreground">
            <div className="flex items-center gap-1">
              ...
              <a href={gmailHref} target="_blank" rel="noopener noreferrer">niteshkumaryadav813@gmail.com</a>
            </div>
            <div className="flex items-center gap-1">
          ...
          <p className="text-muted-foreground text-sm sm:text-base">
             A detail-oriented Full Stack Developer specializing in modern JavaScript frameworks such as React, Next.js, and Express.js. Experienced in crafting secure APIs, optimizing UI performance, and developing end-to-end web solutions to enhance usability and scalability.
          </p>

          <div className="flex flex-wrap gap-2 sm:gap-3">
            <Link
              href="/Nitesh_Resume 9.1.pdf"
              target="_blank"
              download
            >
